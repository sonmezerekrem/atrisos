...
| [`build.mjs`](build.mjs) | Scans `content/` → `nav.json`; copies `templates/manifest.json` → `templates.json` |
| [`templates.json`](templates.json) | Template catalog for the docs grid (generated) |
